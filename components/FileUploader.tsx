...
export default function FileUploader({ onUploaded }: { onUploaded: (signedUrl: string, path: string) => void }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button onClick={upload} className="rounded bg-blue-600 px-3 py-2 text-white">Upload</button>
    </div>
  );
}
