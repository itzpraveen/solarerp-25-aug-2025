...
export default function SettingsPage() {
  ...
  const filteredTeam = normalizedTeamFilter
    ? team.filter((m) => {
        const haystack = [
          m.display_name,
          m.username,
            ...
            <div className={panelClass}>
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-sm text-[var(--text-secondary)]">
                    Manage roles, profile details, and credentials for your team.
                  </p>
                </div>
                ...
                <div className={mutedPanelClass}>
                  <div className="space-y-3">
                    ...
                    <div className="text-xs text-[var(--text-tertiary)]">
                      New users are created with a username and password. If
                      you leave the password empty, the default admin password
                      is used. Passwords cannot be recovered; set a new one to
                      share.
                    </div>
                    <div className="flex flex-wrap items-center gap-2">
                      <Button
